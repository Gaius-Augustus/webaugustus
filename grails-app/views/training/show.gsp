...
<html>
	...
	<body>
               <main class="main-content">
                  ...
                  <p>
                     <g:if test = "${fieldValue(bean:training, field:'job_status') == '0' || fieldValue(bean:training, field:'job_status') == '1' || fieldValue(bean:training, field:'job_status') == '2' || fieldValue(bean:training, field:'job_status') == '3'}">
                  ...
                  <g:if test ="${fieldValue(bean:training, field:'job_error') == '5' || fieldValue(bean:training, field:'job_status') == '5'}">
                     <p>
                        <b><font color="#f40707" size=2>An error occured when executing this job!</font></b>
                     </p>
                     <g:if test = "${training.old_url != null}">
                        <p><b><font color="#FF0000">Data duplication!</font></b> A job with identical data was submitted before. You find the old job at <a href="${training.old_url}">${training.old_url}</a>.
                        </p>
                     </g:if>
                  </g:if>
                  <g:if test="${training.job_status >= '4' && training.results_urls != null}">
                     <hr>
