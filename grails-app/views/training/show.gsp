...
<html>
    ...
    <body>
        <main class="main-content">
            ...
            <p>
                <g:if test = "${fieldValue(bean:training, field:'job_status') == '0' || fieldValue(bean:training, field:'job_status') == '1' || fieldValue(bean:training, field:'job_status') == '2' || fieldValue(bean:training, field:'job_status') == '3' || fieldValue(bean:training, field:'job_status') == '4' || fieldValue(bean:training, field:'job_status') == '7'}">
                    <g:if test = "${training.old_url == null}">
                        <div style="width:600px;height:30px;border:1px solid #d2d2dc">
                            <p>
                                ...
                                <g:if test = "${fieldValue(bean:training, field:'job_status') == '3' || fieldValue(bean:training, field:'job_status') == '7'}">
